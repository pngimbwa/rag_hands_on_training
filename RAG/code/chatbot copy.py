...
def get_weather(city_name):
    ...
    """
    try:
        # Step 1: Make API request to OpenWeatherMap
        params = {
        ...
        # Step 3: Extract relevant weather information from the JSON data
        ...
        # Step 4: Format the extracted weather information into a readable string
        ...
        weather_info = (
            f"In {city_name}, it's currently {temperature}°C with {weather_description}. "
            f"The humidity is around {humidity}%, and the wind is blowing at {wind_speed} meters per second."
        )
        return weather_info  # Return the formatted weather information
        """
...
def stream_weather_response(message):
    ...
    if city_name:
        ...
        weather_prompt = f"""
        Your are a helpful assistant. Based on the following weather data, generate a natural  and friendly weather report for {city_name}:
        ...
        Generat a concise, natural response as if you were a human weatherman.
